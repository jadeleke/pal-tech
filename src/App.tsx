...
function App() {
  ...
  return <div className="app-shell">
    ...
    <footer><div className="footer-brand"><span className="foundation-logo-crop footer-logo"><img className="foundation-logo" src="/play-learn-foundation-logo.png" alt="Play & Learn Foundation"/></span><span><b>Play & Learn Foundation</b><small>Learn • Practice • Play • Build</small></span></div><div className="footer-links"><button onClick={()=>go('about')}>About & Legacy</button><button onClick={()=>go('facilitator')}>Facilitator Corner</button><span>PAL Tech v1.0.0</span></div></footer>
